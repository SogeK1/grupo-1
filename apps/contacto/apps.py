...
'''
Aquí se define una nueva clase llamada ContactoConfig que 
...
class ContactoConfig(AppConfig):
    ...
    Pero en este caso, se ha cambiado explícitamente a 'apps.contacto'. Esta configuración es 
    especialmente útil cuando la aplicación no se encuentra en un paquete de nivel superior.
    '''
    name = 'apps.contacto' # cambiado
